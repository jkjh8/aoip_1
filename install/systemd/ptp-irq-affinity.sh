#!/bin/bash
# eth0 IRQ를 CPU 1에 고정, RT 우선순위 설정 (RT 커널 PTP 안정화)
# CPU 레이아웃: CPU1=eth0 IRQ/ptp4l, CPU2=DSP/ALSA/rtp_recv, CPU3=rtp_send
#
